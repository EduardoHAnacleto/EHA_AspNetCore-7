...
namespace EHA_AspNetCore.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Value,Cost,Stock,Barcode,ImageUrl,ImageThumbnailUrl,Unit,BrandId,CategoryId,Id")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Value,Cost,Stock,Barcode,ImageUrl,ImageThumbnailUrl,Unit,BrandId,CategoryId,Id")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
